package com.share.arthas.demo.helper;
...
public class UserHelper {
     ...
     * <p>
     * watch com.share.arthas.demo.helper.UserHelper testEmptyMethod '{params,returnObj,throwExp,endLine}' -n 5 -x 3
     */
     ...
     * <p>
     * watch com.share.arthas.demo.helper.UserHelper testEmptyWithArg '{params,returnObj,throwExp,endLine}' -n 5 -x 3
     */
     ...
     * <p>
     * watch com.share.arthas.demo.helper.UserHelper testReturnEmpty '{params,returnObj,throwExp,endLine}' -n 5 -x 3
     */
     ...
     * <p>
     * watch com.share.arthas.demo.helper.UserHelper testReturn '{params,returnObj,throwExp,endLine}' -n 5 -x 3
     */
     ...
     * <p>
     * watch com.share.arthas.demo.helper.UserHelper checkThrowException '{params,returnObj,throwExp,endLine}' -n 5 -x 3
     */
     ...
     * test throw exception
     * <p>
     * watch com.share.arthas.demo.helper.UserHelper testLambda '{params,returnObj,throwExp,endLine}' -n 5 -x 3
     */
    ...
    public String testEndline(User user) {
        if (user == null) {
            return StringUtils.EMPTY;
        }
        ...
        if (StringUtils.isBlank(userInDb.getName())) {
            return StringUtils.EMPTY;
        }
        if (!StringUtils.equals(user.getName(), userInDb.getName())) {
            return StringUtils.EMPTY;
        }
        return user.getName();
    }
